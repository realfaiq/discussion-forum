...
function Home() {
    ...
    const slideMenuMargin=()=>{
        return menuOpened?{marginLeft:250}:{};
    }
    const slideMenuWidth=()=>{
        return menuOpened?{width:250}:{};
    }
    return (
        <div>
           <div class="bg-primary text-white"  >
           <div id="mySidebar" class="sidebar" style={slideMenuMargin(),slideMenuWidth()}>
               <a href="javascript:void(0)" class="closebtn" onClick={()=>{menuIconCLicked()}}>&times;</a>
               <div class="container">
                   <h2>All Users</h2>
           ...
           <div id="main" class="d-flex">
               <button class="openbtn" onClick={()=>menuIconCLicked()}>&#9776;</button>
